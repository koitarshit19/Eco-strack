...
const ToastNotification: React.FC<ToastNotificationProps> = ({ actionName, kgSaved, onDismiss }) => {
  return (
    ...
    >
      ...
      <button 
        onClick={onDismiss} 
        className="p-1 rounded-full hover:bg-white/10 text-on-primary/70 hover:text-on-primary focus-visible:ring-2 focus-visible:ring-on-primary focus-visible:outline-none transition-all duration-100 cursor-pointer"
        title="Close Toast"
