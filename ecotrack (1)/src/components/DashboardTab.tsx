          ...
          <section className="bg-gradient-to-br from-primary to-secondary text-on-primary rounded-3xl p-6 relative overflow-hidden group flex flex-col justify-between flex-1 min-h-[220px] shadow-lg" aria-labelledby="daily-mission-title">
            ...
            <div className="relative z-10 mt-6">
              <button
                ...
                className={`w-full py-3 rounded-2xl font-bold text-xs tracking-widest uppercase transition-all duration-200 active:scale-95 focus-visible:ring-2 focus-visible:ring-white focus-visible:outline-none flex items-center justify-center gap-2 cursor-pointer ${
                  dailyMissionCompleted
                    ? 'bg-white/20 text-white border border-white/10 cursor-not-allowed'
