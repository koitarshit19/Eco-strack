                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-outline-variant/10">
                      ...
                      <div className="flex items-center bg-background rounded-full px-3 py-1 gap-3 border border-outline-variant/35">
                        <button
                          ...
                          className="w-6 h-6 rounded-full bg-surface hover:bg-surface-container text-on-surface flex items-center justify-center active:scale-90 transition-transform cursor-pointer border border-outline-variant/10"
                      ...
                      <button
                        ...
                        className="bg-primary text-on-primary rounded-full px-4 py-2 hover:bg-primary/90 transition-all cursor-pointer text-xs font-bold tracking-wider uppercase flex items-center gap-1 shadow-md active:scale-95"
                        title={`Log ${item.name}`}
                      >
