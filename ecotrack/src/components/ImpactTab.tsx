    ...
    <div className="space-y-12 animate-[fadeIn_0.5s_ease-out]">
      ...
      <section className="flex flex-col md:flex-row gap-8 items-center bg-surface border border-outline-variant/65 p-8 rounded-3xl relative overflow-hidden shadow-xl">
        <div className="z-10 flex-1 space-y-4">
          ...
          <p className="text-sm md:text-base text-on-surface-variant font-normal leading-relaxed max-w-xl">
          ...
          <div className="pt-4 flex flex-wrap gap-4">
            <button
              ...
              className="bg-primary text-on-primary hover:bg-primary/95 font-sans text-xs tracking-wider uppercase font-bold px-5 py-3 rounded-full cursor-pointer shadow-md active:scale-95 duration-150 flex items-center gap-1.5"
            >
              <Share2 className="w-4 h-4" /> Share Milestone
            </button>
            <button
              onClick={() => setShowDetailsModal(true)}
              className="bg-surface border border-outline-variant/50 text-on-surface hover:bg-surface-container-high font-sans text-xs tracking-wider uppercase font-bold px-5 py-3 rounded-full cursor-pointer active:scale-95 duration-150 flex items-center gap-1.5"
            >
      ...
      <section className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-outline-variant/20 pb-3">
          ...
          <div className="flex bg-surface-container rounded-full p-1 border border-outline-variant/15 self-start">
          ...
          {achievements.map((ach) => (
            ...
            >
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-on-surface-variant/90 max-w-[140px] leading-relaxed font-normal">
              ...
              <div className="mt-4 w-full flex justify-center">
                {ach.locked ? (
                  <button
                    ...
                    className="px-4 py-2 bg-primary text-on-primary text-xs font-bold rounded-full shadow-md cursor-pointer active:scale-95"
                  >
                    Unlock Unit
                  </button>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-[fadeIn_0.2s_ease-out]">
          <div className="bg-surface border border-outline-variant/30 rounded-3xl max-w-md w-full p-6 shadow-2xl relative space-y-6">
            <button
              ...
              className="absolute top-4 right-4 p-1 rounded-full border border-outline-variant/30 bg-surface-container hover:bg-surface-container-high text-on-surface active:scale-95 transition-transform cursor-pointer"
            >
              <X className="w-4 h-4" />
            </button>
            <div className="text-center space-y-2 pb-2 border-b border-outline-variant/20">
              ...
              <h4 className="text-2xl font-bold text-primary">Carbon Milestone</h4>
            ...
            <div className="flex gap-4">
              <button
                ...
                className="flex-1 py-3 bg-primary text-on-primary hover:bg-primary/95 transition-all text-xs font-bold rounded-full flex items-center justify-center gap-2 cursor-pointer shadow active:scale-95"
              >
                {copied ? (
                  <>
                  ...
                  <>
                    <Share2 className="w-4 h-4" /> Copy Message Link
                  </>
                )}
              </button>
              <button
                onClick={() => setShowShareModal(false)}
                className="py-3 px-6 border border-outline-variant/30 hover:bg-surface-container text-on-surface text-xs font-bold rounded-full active:scale-95 transition-all cursor-pointer"
              >
                Close
              </button>
            </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-[fadeIn_0.2s_ease-out]">
          <div className="bg-surface border border-outline-variant/30 rounded-3xl max-w-lg w-full p-6 shadow-2xl relative space-y-6 max-h-[85vh] overflow-y-auto">
            <button
              ...
              className="absolute top-4 right-4 p-1 rounded-full border border-outline-variant/20 bg-surface-container hover:bg-surface-container-high text-on-surface active:scale-95 transition-transform cursor-pointer"
            >
              <X className="w-4 h-4" />
            </button>
            <div className="space-y-2 pb-3 border-b border-outline-variant/30">
              <h4 className="text-2xl font-bold text-primary">Calculation Schema</h4>
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center bg-surface-container-low p-3 rounded-2xl border border-outline-variant/20 text-xs font-normal">
                <span className="text-on-surface-variant font-medium">Walking instead of Driving</span>
                <span className="text-primary font-bold">+0.4 kg CO2 / km</span>
              </div>
              <div className="flex justify-between items-center bg-surface-container-low p-3 rounded-2xl border border-outline-variant/20 text-xs font-normal">
                <span className="text-on-surface-variant font-medium">Biking instead of Driving</span>
                <span className="text-primary font-bold">+0.3 kg CO2 / km</span>
              </div>
              <div className="flex justify-between items-center bg-surface-container-low p-3 rounded-2xl border border-outline-variant/20 text-xs font-normal">
                <span className="text-on-surface-variant font-medium">Switching to Plant-based Meal</span>
                <span className="text-primary font-bold">+2.1 kg CO2 / meal</span>
              </div>
              <div className="flex justify-between items-center bg-surface-container-low p-3 rounded-2xl border border-outline-variant/20 text-xs font-normal">
                <span className="text-on-surface-variant font-medium">Using Dairy Alternatives</span>
                <span className="text-primary font-bold">+0.8 kg CO2 / serving</span>
              </div>
              <div className="flex justify-between items-center bg-surface-container-low p-3 rounded-2xl border border-outline-variant/20 text-xs font-normal">
                <span className="text-on-surface-variant font-medium">Switching Off Lights</span>
                <span className="text-primary font-bold">+0.1 kg CO2 / hr</span>
              </div>
              <div className="flex justify-between items-center bg-surface-container-low p-3 rounded-2xl border border-outline-variant/20 text-xs font-normal">
                <span className="text-on-surface-variant font-medium">Cold Wash Cycle</span>
            ...
            <div className="flex justify-end pt-2">
              <button
                onClick={() => setShowDetailsModal(false)}
                className="py-2.5 px-6 bg-primary text-on-primary hover:bg-primary/95 transition-all text-xs font-bold rounded-full active:scale-95 cursor-pointer"
              >
                Understood
              </button>
            </div>
