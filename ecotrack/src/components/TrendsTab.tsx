      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 bg-surface border border-outline-variant/65 rounded-3xl p-6 shadow-md space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-outline-variant/20 pb-4">
            ...
            <div className="flex flex-wrap gap-1 bg-surface-container-low rounded-full p-1 border border-outline-variant/10">
              ...
              filteredLogs.map((log) => (
                <div key={log.id} className="flex items-center justify-between p-4 bg-surface-container-low hover:bg-surface-container transition-colors rounded-2xl border border-outline-variant/15">
                  <div className="flex items-center gap-3">
                    <span className="text-xs uppercase font-extrabold px-3 py-1 tracking-wider bg-background border border-outline-variant/30 rounded-full text-on-surface-variant/80">
                      {log.category}
                    </span>
                    <div>
                      <p className="text-base font-bold text-on-surface leading-snug">{log.name}</p>
                      <p className="text-[11px] font-semibold text-on-surface-variant/70 mt-0.5">{log.value.toFixed(1)} {log.unit} logged</p>
                    </div>
                  </div>
